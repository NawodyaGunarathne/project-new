...
<body class="bg-dark">
  ...
  <div class="container-fluid">
    <img src="/Assignment Project/images/jjjjj.png" class="logo">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/Assignment Project/display_all.php.">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../index.php">Vote</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="registration.php">Candidate</a>
        </li>
        <li class="nav-item">
